...
- **Ally Esprit chance fitted at 0.205** (0.212 on the first pass, before the defaults were final). The game only says the chance that an ally's weaponskill feeds the dancer 10 Esprit "differs according to job"; the community's estimate is about 0.20. Fitting it so the simulated Saber Dance + Dance of the Dawn rate matches the top 10 (4.17 per minute) lands on the same number, which is good evidence that the Esprit model is right.
