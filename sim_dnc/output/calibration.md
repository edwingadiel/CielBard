...
Fitted `ally_esprit.chance` = **0.205** (community estimate: about 0.20).

## 2. Damage scalar

- fitted `potency_to_damage` = **117.7620** (was 117.5858)
- auto attacks are 9.95% of parse damage and are removed from the target
- residual: mean |error| 0.88%, worst -3.86%
- engine vs top-10 mean: -1.38%
...
|---|---:|---:|---:|---:|
| Cascade | 3.650 | 3.327 | 3.370 | +9.7% |
| Fountain | 3.515 | 3.221 | 3.154 | +9.1% |
| Reverse Cascade | 2.475 | 2.587 | 2.551 | -4.3% |
| Fountainfall | 2.695 | 2.467 | 2.561 | +9.2% |
| Saber Dance | 3.702 | 3.585 | 3.556 | +3.3% |
| Dance of the Dawn | 0.576 | 0.588 | 0.585 | -2.0% |
| Last Dance | 1.951 | 2.080 | 2.048 | -6.2% |
| Finishing Move | 1.046 | 1.046 | 1.038 | +0.0% |
| Standard Step | 0.940 | 0.929 | 0.929 | +1.2% |
| Technical Step | 0.576 | 0.588 | 0.585 | -2.0% |
| Tillana | 0.549 | 0.588 | 0.573 | -6.5% |
| Starfall Dance | 0.552 | 0.588 | 0.582 | -6.0% |
| Flourish | 1.058 | 1.058 | 1.053 | -0.0% |
| Devilment | 0.588 | 0.588 | 0.585 | -0.0% |
| Fan Dance | 2.551 | 2.516 | 2.660 | +1.4% |
| Fan Dance III | 2.224 | 2.328 | 2.510 | -4.4% |
| Fan Dance IV | 1.058 | 1.058 | 1.053 | -0.0% |
| all weaponskills (steps excluded) | 23.626 | 23.403 | 23.357 | +1.0% |
...
| Tillana > Dance of the Dawn > Last Dance > Saber Dance > Starfall Dance > Saber Dance | 0% | 10% |
| Dance of the Dawn > Tillana > Saber Dance > Last Dance > Saber Dance > Saber Dance | 0% | 10% |
...
- esprit_wasted: 6.75
- feathers_wasted: 0.00
- gcd_idle_s: 0.00
- wrong_steps: 0.00
- broken_combos: 0.00
- lapsed / overwritten procs: none
